...
export const postData = [
    ...
    { id: 4, postType:'education',  name: 'Joseph Gray', views: '1.4k', postTypeImg: '/job.png', profileImg: '/profile_4.png', postHeading:'Software Developer', buttomData: 'Apply on Timesjob',postTimeLine: {desc1: `Innovaccer Analytics pvt ltd.`, desc2: `Noida, India`, logo1:'/bag.png', logo2: '/location.png' },  cName: 'jobs',  },
]